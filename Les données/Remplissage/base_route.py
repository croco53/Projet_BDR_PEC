...
# -*- coding: utf-8 -*-
"""
Created on Fri Jun 19 15:41:59 2020
...
def data_route():
    tab = []
    with open('/users/pierrine/Desktop/route_propre.csv', 'r', encoding='utf-8') as f:
        reader = csv.reader(f)
        for line in reader:
...
for i in range(1, len(data)-1):
    cur.execute("""
        INSERT INTO  postgres."postgres"(id_route,id_aero_dep,id_aero_arr,id_comp)
        VALUES (%s,%s,%s,%s);
        """,
